...
public class Gambar extends JFrame{
    ...
    JLabel lstr = new JLabel("Tipe Garis : ");
    JLabel lteb = new JLabel("Tebal Garis : ");
    ...
    String CusLineDat[][] = {{"Line", "asset\\linelurus.png"},
            {"Dash", "asset\\dotted2.png"},
            {"Dot", "asset\\dottedline.png"},
    };
    ...
    public Gambar() {
        setTitle("Project Akhir Grafkom Paint Lite");
        setSize(1250, 600);
        ...
        Image fillcl;
        try {
            fillcl = ImageIO.read(new File("asset\\fillcolor.png")).getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ...
        Image linecl;
        try {
            linecl = ImageIO.read(new File("asset\\linecolor.png")).getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ...
        clearButton.setPreferredSize(new Dimension(105,35));
